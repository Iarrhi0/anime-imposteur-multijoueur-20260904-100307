const CACHE="anime-imposteur-v7-2";
const SHELL=["./","./index.html","./style.css?v=7.2","./app.js?v=7.2","./ai-engine.js?v=7.2","./bot-engine.js?v=7.2","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png"];
